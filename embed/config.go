...
import (
	...
	"github.com/mosheya/etcd/pkg/netutil"
	"github.com/mosheya/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://github.com/mosheya/etcd/issues/9333 for more detail.
...
func (cfg *Config) SetupLogging() {
	...
	if cfg.LogPkgLevels != "" {
		repoLog := capnslog.MustRepoLogger("github.com/mosheya/etcd")
