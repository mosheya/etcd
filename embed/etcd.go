...
var plog = capnslog.NewPackageLogger("github.com/mosheya/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/mosheya/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
