...
- [go-etcd](https://github.com/mosheya/go-etcd) - the deprecated official client. May be useful for older (<2.0.0) versions of etcd.
...
- [mosheya/jetcd](https://github.com/etcd-io/jetcd) - Supports v3
