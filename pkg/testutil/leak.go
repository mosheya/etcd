...
running(leaking) after all tests.
	...
	import "github.com/mosheya/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/mosheya/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/mosheya/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
